...
调用方式:
    python strategies/runners/run_strategy.py --strategy MFM_5F_M_CON --start 20240601 --end 20251130
"""
...
STRATEGY_INFO = {
    'name': '多因子5月度保守策略',
    'code': 'MFM_5F_M_CON',
    'version': 'v1.0-conservative',
    'author': '量化策略组',
    'create_date': '2025-12-30',
    'description': '基于5因子的保守型月度策略',
}
